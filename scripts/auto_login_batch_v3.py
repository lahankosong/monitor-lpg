"""
auto_login_batch.py v3
- Fix buffering di Windows (PYTHONUNBUFFERED)
- Output ke file JSON
- Progress ke stderr agar tidak tercampur JSON
"""
...
# Force unbuffered output di Windows
sys.stdout.reconfigure(line_buffering=True)
sys.stderr.reconfigure(line_buffering=True)


def log(msg: str):
    """Print progress ke stderr — tidak tercampur dengan JSON output."""
